  ...
  describe('when getting community voice chat credentials', () => {
    describe('and the request is successful', () => {
      ...
      it('should return connection URL', async () => {
        ...
        expect(mockFetch).toHaveBeenCalledWith(
          `${gatekeeperUrl}/community-voice-chat/join`,
          {
            method: 'POST',
            headers: {
            ...
            body: JSON.stringify({
              ...
              member_address: testUserAddress
            })
          }
        )
      })
    ...
    describe('and the request fails', () => {
      ...
      it('should throw an error', async () => {
        await expect(
          commsGatekeeper.getCommunityVoiceChatCredentials(
            testCommunityId,
            testUserAddress
          )
  ...
  describe('when creating a community voice chat room', () => {
    describe('and the request is successful', () => {
      ...
      it('should create room successfully and return connection URL', async () => {
        ...
        expect(mockFetch).toHaveBeenCalledWith(
          `${gatekeeperUrl}/community-voice-chat`,
          {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            ...
            body: JSON.stringify({
              community_id: testCommunityId,
              moderator_address: testUserAddress
            })
          }
        )
      })
    ...
    describe('and the request fails', () => {
      ...
      it('should throw an error', async () => {
        await expect(
          commsGatekeeper.createCommunityVoiceChatRoom(testCommunityId, testUserAddress)
  ...
  describe('when updating user metadata in community voice chat', () => {
    describe('and the request is successful', () => {
      ...
      it('should update metadata successfully', async () => {
        ...
        await commsGatekeeper.updateUserMetadataInCommunityVoiceChat(
          testCommunityId,
          testUserAddress,
          metadata
        )
        ...
        expect(mockFetch).toHaveBeenCalledWith(
          `${gatekeeperUrl}/community-voice-chat/${testCommunityId}/users/${testUserAddress}/metadata`,
          {
            method: 'PATCH',
            headers: {
              'Content-Type': 'application/json',
    ...
    describe('and the request fails', () => {
      ...
      it('should throw an error', async () => {
        ...
        await expect(
          commsGatekeeper.updateUserMetadataInCommunityVoiceChat(
            testCommunityId,
            testUserAddress,
            metadata
          )
  ...
  describe('when getting community voice chat status', () => {
    describe('and the request is successful with active chat', () => {
      ...
      it('should return chat status', async () => {
        ...
        expect(mockFetch).toHaveBeenCalledWith(
          `${gatekeeperUrl}/community-voice-chat/${testCommunityId}/status`,
          {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
    ...
    describe('and the request fails with non-404 error', () => {
      ...
      it('should throw an error', async () => {
        await expect(
          commsGatekeeper.getCommunityVoiceChatStatus(testCommunityId)
  ...
  describe('when checking if user is in a voice chat', () => {
    describe('and the request is successful with user in chat', () => {
      ...
      it('should return true', async () => {
        ...
        expect(mockFetch).toHaveBeenCalledWith(
          `${gatekeeperUrl}/users/${testUserAddress}/voice-chat-status`,
          {
            method: 'GET',
            headers: {
              'Content-Type': 'application/json',
    ...
    describe('and the request fails', () => {
      ...
      it('should throw an error', async () => {
        await expect(
          commsGatekeeper.isUserInAVoiceChat(testUserAddress)
        ).rejects.toThrow('Server responded with status 500')
      })
    })
  })
